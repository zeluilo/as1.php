...
$results = $pdo->query('SELECT * FROM user')->fetchAll();
?>
...
<body>
    ...
    <table>
        ...
        <td>
            <a href='editAdmin.php?upId=" . $row["userId"] . "'><button  class='btnedit'>EDIT</button></a>
            <a href='deleteAdmin.php?delId=" . $row["userId"] . "'><button  class='btndelete'>DELETE</button></a>
        </td>
    </tr>";
        }
        ?>
